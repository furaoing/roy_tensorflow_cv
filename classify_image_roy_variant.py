...
def predict_image(image, config):
    ...
    def run_inference_on_image(image, config):
    ...
    run_inference_on_image(image, config)
...
if __name__ == '__main__':
    ...
    image_path = "/home/furaoing/tensorflow/inception-2015-12-05/cropped_panda.jpg"
    image_path2 = "/home/furaoing/images_test/test1.jpg"
    
    predict_image(image_path, roy_config)
